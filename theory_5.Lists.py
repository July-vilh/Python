...
# ВЫВОД ЭЛЕМЕНТОВ СПИСКА (слева направо!)
...
# ВЫВОД ЭЛЕМЕНТОВ СПИСКА (справа налево!) НУМЕРАЦИЯ НАЧИНАЕТСЯ С -1 и далее -2, -3 и т.д.
...
#Перемножение более 1 элемента в массиве:
l7 = ['Anna', 'Elena', 7]
l77 = l7 * 4
print(l77)

# РЕЗУЛЬТАТ:
['Anna', 'Elena', 7, 'Anna', 'Elena', 7, 'Anna', 'Elena', 7, 'Anna', 'Elena', 7]

_________________________________________________________________________

# Редактирование списка (вместо 1-ого элемента НОВЫЙ элемент):
